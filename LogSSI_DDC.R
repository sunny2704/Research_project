...
bf_c <- as.data.frame(read.csv("E:/DDC Test/ToeSegmentation2_ClusterInfo.csv", header = F))
b_tr <- as.data.frame(read.csv("E:/DDC Test/ToeSegmentation2_TRAIN.csv", header = F))
b_te <- as.data.frame(read.csv("E:/DDC Test/ToeSegmentation2_TEST.csv", header = F))
