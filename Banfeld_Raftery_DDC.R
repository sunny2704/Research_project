...
bf_c <- as.data.frame(read.csv("E:/DDC Test/Wine_ClusterInfo.csv", header = F))
b_tr <- as.data.frame(read.csv("E:/DDC Test/Wine_TRAIN.csv", header = F))
b_te <- as.data.frame(read.csv("E:/DDC Test/Wine_TEST.csv", header = F))
