...
bf_c <- as.data.frame(read.csv("Meat_ClusterInfo.csv", header = F))
b_tr <- as.data.frame(read.csv("Meat_TRAIN.csv", header = F))
b_te <- as.data.frame(read.csv("Meat_TEST.csv", header = F))
