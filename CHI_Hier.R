...
bf_c <- as.data.frame(read.csv("SonyAIBORobotSurface_ClusterInfo.csv", header = F))
b_tr <- as.data.frame(read.csv("SonyAIBORobotSurface_TRAIN.csv", header = F))
b_te <- as.data.frame(read.csv("SonyAIBORobotSurface_TEST.csv", header = F))
